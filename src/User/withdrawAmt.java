...
public class withdrawAmt extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					withdrawAmt frame = new withdrawAmt();
			...
			public void actionPerformed(ActionEvent e) {
				...
				//String id1=id.getText();
					...
					if(j==1)
					{
						...
						JOptionPane.showMessageDialog(btnNewButton,"Congratulations,"+n+"Withdrawal successful"+n+"Thankyou.");
					}
					else
					{
